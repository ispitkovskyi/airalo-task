...
public class Entity {
    ...
    /**
     *
     * @param nameValueMap - map with Name - Value pairs, to be used to set fields (class-level variables) in created instance
     *                      where each Name must be equal to "value" in @JsonProperty annotation, assigned to respective property (class-level variable)
     * @throws Exception
     */
    //MEMO: It automatically makes casting to type of respective field
    public <T extends Entity> Entity(HashMap<String, Object> nameValueMap) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends Entity> T newInstance(Class<T> entityType, HashMap<String, Object> nameValueMap) throws Exception {
        if(nameValueMap==null)
            throw new Exception("No name-value map was provided to create Entity instance");

        if(entityType==null)
            entityType = (Class<T>) Entity.class;
    ...
    private static <T extends Entity> void getEntityFieldsAndSetValues(T entityInstance, HashMap<String, Object> fieldValuesMap) throws Exception {
    ...
    private static <T extends Entity> void setEntityFields(T entityInstance, List<Field> entityFields, HashMap<String, Object> fieldValuesMap) throws Exception {
